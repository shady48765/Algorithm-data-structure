/*************************************************************************
	> File Name: 99kruskal.c
	> Author: 
	> Mail: 
	> Created Time: 2018年08月22日 星期三 16时10分56秒
 ************************************************************************/
...
//qsort 排序函数中使用，使edges结构体中的边按照权值大小升序排序
...
int main(){
    ...
    //对连通网中的所有边进行升序排列，结果仍保存在edges数组中
